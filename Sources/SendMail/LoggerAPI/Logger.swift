...
public class Log {
	...
	nonisolated(unsafe) private static var _loggerLock: NSLock = NSLock()
	...
	nonisolated(unsafe) private static var _swiftLogger:LoggerMain?
	nonisolated(unsafe) private static var _swiftLoggerLock: NSLock = NSLock()
    ...
    public static var swiftLogger:LoggerMain? {
        get {
