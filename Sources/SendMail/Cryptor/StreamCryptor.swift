...
public class StreamCryptor {
	...
	public struct Options: OptionSet {
		...
		/// No options
		nonisolated(unsafe) public static let none = Options([])
		
		#if os(macOS) || os(iOS) || os(tvOS) || os(watchOS)
		
			/// Use padding. Needed unless the input is a integral number of blocks long.
		nonisolated(unsafe) public static var pkcs7Padding =  Options(rawValue:kCCOptionPKCS7Padding)
		
			/// Electronic Code Book Mode. Don't use this.
		nonisolated(unsafe) public static var ecbMode = Options(rawValue:kCCOptionECBMode)
