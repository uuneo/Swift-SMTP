...
struct FatalErrorUtil {
	...
	nonisolated(unsafe) static var fatalErrorClosure: (String, StaticString, UInt) -> Never = defaultFatalErrorClosure
	nonisolated(unsafe) private static let defaultFatalErrorClosure = { Swift.fatalError($0, file: $1, line: $2) }
